...
module.exports = {
    command: 'install',
    alias: 'in',
    description: 'install templates and generators\n\tIf no arguments is passed it will install all generators and templates in the .heinzelrc',
    options: [
    ...
    if (!_.isArray(options.gen) && !_.isArray(options.tem) && !_.isString(options.gen) && !_.isString(options.tem)) {
        return heinzel.listGenerators()
            .then(function(generators) {
                return heinzel.installGenerators(generators, true);
            })
            .then(function(generators) {
            ...
            .then(function(templates) {
                return heinzel.installTemplates(templates, true);
            })
            .then(function(templates) {
